  ...
  Widget build(BuildContext context) {
    return StreamBuilder(
        ...
        builder: (context, snapshotLogin) {
          if (snapshotLogin.connectionState == ConnectionState.waiting) {
            return Loading();
          } else if (snapshotLogin.hasError) {
            return Center(
              child: Text('Something Went Wrong'),
            );
          } else if (snapshotLogin.hasData) {
            return Scaffold(
              ...
              body: SafeArea(
                  child: StreamBuilder<List<Todo>?>(
                      ...
                      builder: (context, snapshotList) {
                        ...
                        List<Todo>? all = snapshotList.data;
                        return Padding(
                              ...
                              ListView.separated(
                                  ...
                                  itemBuilder: (context, index) {
                                    return Dismissible(
                                      ...
                                      child: ListTile(
                                        onTap: () async {
                                          if ((all as dynamic)[index]
                                              .isChecked) {
                                            await DatabaseService()
                                                .notCompletedTask(
                                                    (all as dynamic)[index]
                                                        .uid);
                                          } else {
                                            await DatabaseService()
                                                .completeTask(
                                        ...
                                        leading: Container(
                                          ...
                                          child:
                                              (all as dynamic)[index].isChecked
                                                  ? Icon(
                                                      Icons.check,
                                                      color: Colors.white,
                                                    )
                              ...
                              child: TextButton(
                                onPressed: () async {
                                  if (titleController.text.isNotEmpty) {
                                    await DatabaseService().createNewOne(
